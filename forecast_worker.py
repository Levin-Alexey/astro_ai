...
На основе этих положений выдай прогноз на сегодня ({current_date}) по следующему алгоритму: 
Упоминание о дате прогноза {current_date}
...
Сделай прогноз строго до 2500 символов, не больше!
"""
