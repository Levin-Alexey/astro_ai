...
SUN_RECOMMENDATIONS_PROMPT = """Дай личные рекомендации для проработки Солнца и его нормальной работы. Просто списком по пунктам, без воды. После списка напиши какие будут положительные результаты, если следовать этим рекомендациям (например, уверенность в себе, лидерские качества, творческая реализация, жизненная энергия, самооценка и так далее).
