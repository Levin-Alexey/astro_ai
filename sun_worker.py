...
class SunWorker:
    ...
    def format_prediction_message(self, prediction: Prediction, user: User, profile_name: Optional[str] = None) -> str:
        ...
        # Убираем приветствие - оставляем только основное сообщение
