    ...
    if has_moon_analysis:
        ...
        await message.answer(
            (
                ...
                "Чтобы начать трансформации, мне понадобятся только твои дата, время и место рождения 🤗🎁\n\n"
...
async def on_explore_other_areas(callback: CallbackQuery):
    ...
    await cb_msg.answer(
        ...
        "🎄 <b>Новинка к Новому году - Какое личное качество особенно ждет твоего внимания в 2026 году?</b>\n\n"
        "🧠 <b>Меркурий</b>\n"
        "результат: развитие речи и мышления, умение убеждать и договариваться, лёгкое обучение и ясная подача идей\n"
        "🎄 <b>Новинка к Новому году — Как грамотно и эффективно планировать год именно тебе?</b>\n\n"
        "💰💍 <b>Венера</b>\n"
        ...
        "🎄 <b>Новинка к Новому году - Какой подарок купить себе, чтобы получить удовольствие, а не сожаление?</b>\n\n"
        "⚡️ <b>Марс</b>\n"
        "результат: рост мотивации и силы воли, решительность, спортивный дух, умение разрешать конфликты и уверенно начинать новое\n\n"
        "\n"
        "🎄 <b>Новинка к Новому году — Как тебе начать год так, чтобы не слиться через месяц?</b>\n\n"
        "💌 <b>Одна планета + личные рекомендации — 77₽ (вместо 999₽)</b>\n"
        "💣 <b>Разборы ВСЕХ планет — 222₽ (вместо 5555₽)</b>\n\n"
