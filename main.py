...
async def on_explore_other_areas(callback: CallbackQuery):
    ...
    await cb_msg.answer(
        ...
        "🎄 Новинка к Новому году — Какое личное качество особенно ждет твоего внимания в 2026 году? \n\n"
        "🧠 <b>Меркурий</b>\n"
        "результат: развитие речи и мышления, умение убеждать и договариваться, лёгкое обучение и ясная подача идей\n"
        "🎄 Новинка к Новому году — Как грамотно и эффективно планировать год именно тебе? \n\n"
        "💰💍 <b>Венера</b>\n"
        ...
        "🎄 Новинка к Новому году — Какой подарок купить себе, чтобы получить удовольствие, а не сожаление?  \n\n"
        "⚡️ <b>Марс</b>\n"
        "результат: рост мотивации и силы воли, решительность, спортивный дух, умение разрешать конфликты и уверенно начинать новое\n"
        "🎄 Новинка к Новому году — Как тебе начать год так, чтобы не слиться через месяц? \n\n"
        "\n"
